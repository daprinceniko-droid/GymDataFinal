...
interface ResultPanelProps {
  ...
  /** Either an image asset OR a big emoji to show */
...
/**
 * Full-viewport scrollytelling panel with animated reveal.
 * Wave dividers are rendered by the parent, not inside the panel.
 */
      ...
      <div className="flex-1 flex flex-col items-center justify-center text-center max-w-3xl mx-auto px-6 py-20 w-full">
        {kicker && (
          <motion.p
            ...
            className="text-foreground text-lg md:text-xl font-display mb-3 text-shadow-soft"
          >
            {kicker}
          </motion.p>
        )}
