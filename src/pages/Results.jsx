        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <motion.div variants={itemVariants} whileHover="hover">
              <FrostedCard variant="light" className="md:col-span-2" animate={{ scale: 1 }}>
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-white text-opacity-70 mb-2 font-semibold">Daily Calorie Target</p>
                    <div className="text-6xl font-bold text-white drop-shadow-lg">
                      <AnimatedValue value={results.calorieTarget} duration={1200} suffix=" " />
                    </div>
                    <p className="text-white text-opacity-80 mt-2">kcal per day</p>
                  </div>
            ...
            <motion.div variants={itemVariants} whileHover="hover">
              <FrostedCard variant="light">
                <div className="text-center">
                  <p className="text-white text-opacity-70 mb-3 font-semibold">Protein Target</p>
                  <div className="text-5xl font-bold text-white drop-shadow-lg">
                    <AnimatedValue value={results.proteinTarget} duration={1200} suffix="g" />
                  </div>
                  <p className="text-white text-opacity-80 mt-2 text-sm">grams per day</p>
                </div>
              </FrostedCard>
            </motion.div>
            ...
            <motion.div variants={itemVariants} whileHover="hover">
              <FrostedCard variant="light">
                <div className="text-center">
                  <p className="text-white text-opacity-70 mb-3 font-semibold">Carbohydrates</p>
                  <div className="text-5xl font-bold text-white drop-shadow-lg">
            ...
            <motion.div variants={itemVariants} whileHover="hover">
              <FrostedCard variant="light">
                <div className="text-center">
                  <p className="text-white text-opacity-70 mb-3 font-semibold">Healthy Fats</p>
                  <div className="text-5xl font-bold text-white drop-shadow-lg">
          ...
          <motion.div variants={itemVariants} initial="hidden" animate="visible" transition={{ delay: 0.4 }}>
            <FrostedCard variant="light" className="mb-8">
              <h3 className="text-3xl font-bold text-white mb-6 font-secondary drop-shadow-lg">
                Calorie Breakdown
              </h3>
              <div className="space-y-4">
                <div className="flex justify-between items-center pb-4 border-b border-white border-opacity-20">
                  <span className="font-semibold text-white">Basal Metabolic Rate (BMR)</span>
                  <span className="text-2xl font-bold text-white drop-shadow-lg">
                    <AnimatedValue value={results.bmr} duration={1200} suffix=" kcal" />
                  </span>
                </div>
                <div className="flex justify-between items-center pb-4 border-b border-white border-opacity-20">
                  <span className="font-semibold text-white">Total Daily Energy (TDEE)</span>
                  <span className="text-2xl font-bold text-white drop-shadow-lg">
                    <AnimatedValue value={results.tdee} duration={1200} suffix=" kcal" />
                  </span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="font-semibold text-white">Your Daily Target</span>
          ...
          >
            ...
            <motion.div variants={itemVariants} whileHover="hover">
              <FrostedCard variant="light">
                <h4 className="text-2xl font-bold text-white mb-4 font-secondary">🥩 Protein</h4>
            ...
            <motion.div variants={itemVariants} whileHover="hover">
              <FrostedCard variant="light">
                <h4 className="text-2xl font-bold text-white mb-4 font-secondary">🍝 Carbs</h4>
                <div className="space-y-2">
                  <p className="text-white text-opacity-90">
                    <span className="font-semibold">
                      <AnimatedValue value={results.macros.carbs} duration={1200} suffix="g" />
            ...
            <motion.div variants={itemVariants} whileHover="hover">
              <FrostedCard variant="light">
                <h4 className="text-2xl font-bold text-white mb-4 font-secondary">🧈 Fats</h4>
                <div className="space-y-2">
                  <p className="text-white text-opacity-90">
                    <span className="font-semibold">
                      <AnimatedValue value={results.macros.fats} duration={1200} suffix="g" />
          ...
          <motion.div variants={itemVariants} initial="hidden" animate="visible" transition={{ delay: 0.8 }}>
            <FrostedCard variant="dark" className="mb-8">
              <p className="text-white">
                💡 <strong className="text-pink-200">Pro Tip:</strong> These are your targets for optimal nutrition.
          ...
          >
            <Link
              to="/breakdown"
              className="inline-block bg-white hover:bg-pink-100 text-darkTeal font-bold py-3 px-8 rounded-full transition transform hover:scale-105 shadow-lg-soft text-center"
            >
              Learn How We Calculated 📚
            </Link>
            <Link
              to="/calculate"
              className="inline-block bg-pink-300 hover:bg-pink-400 text-white font-bold py-3 px-8 rounded-full transition transform hover:scale-105 shadow-lg-soft text-center"
            >
              Calculate Again
            </Link>
          </motion.div>
