...
export default function ResultsTransition() {
  ...
  return (
    <motion.div
      className={`w-full h-screen bg-gradient-to-b from-pink-200 via-pink-100 to-mint-200 flex flex-col items-center justify-center px-4 transition-opacity duration-500 overflow-hidden ${fadeOut ? 'opacity-0' : 'opacity-100'}`}
    ...
    >
      ...
      >
        <p className="text-center font-semibold text-pink-400 mb-2 text-base">
          Awesome!
        </p>
        <p className="text-center text-darkTeal font-medium text-sm leading-relaxed">
