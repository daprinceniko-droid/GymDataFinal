  ...
  return (
    <div className="w-full overflow-hidden">
      <section className="bg-pink-soft pt-28 pb-8 px-6 text-center">
        <h1 className="text-5xl md:text-6xl text-pink-ink text-shadow-soft mb-3">My Profile</h1>
        <p className="text-pink-ink/80 text-lg">Your personalized settings and information</p>
      </section>
      ...
      <section className="bg-green-soft py-16 px-6 min-h-[50vh] flex items-center justify-center">
        <div className="rounded-3xl p-10 shadow-card text-center max-w-md"
          ...
          <p className="text-foreground/90">Your profile page with saved data and personalisation will be available soon!</p>
        </div>
      </section>
